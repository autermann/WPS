...
public class GTHelper {
	private static final Logger LOGGER = LoggerFactory.getLogger(GTHelper.class);
    ...
    public static SimpleFeatureType createFeatureType(
            Collection<Property> attributes, Geometry newGeometry, String uuid,
        ...
        for (Property property : attributes) {
            ...
            if ((binding.equals(Geometry.class) ||
                ...
                if (newGeometry.getClass().equals(Point.class) && (!name
                        .equals("location"))) {
                    typeBuilder.add("GEOMETRY", MultiPoint.class);
                } else if (newGeometry.getClass().equals(LineString.class) &&
                           (!name.equals("location"))) {

                    typeBuilder.add("GEOMETRY", MultiLineString.class);
                } else if (newGeometry.getClass().equals(Polygon.class) &&
                           (!name.equals("location"))) {
                ...
                if (!name.equals("location") && binding.equals(Object.class)) {
                    try {
                        ...
                        if (g.getClass().equals(Point.class) && (!name
                                .equals("location"))) {
                            typeBuilder.add("GEOMETRY", MultiPoint.class);
                        } else if (g.getClass().equals(LineString.class) &&
                                   (!name.equals("location"))) {

                            typeBuilder.add("GEOMETRY", MultiLineString.class);
                        } else if (g.getClass().equals(Polygon.class) &&
                                   (!name.equals("location"))) {
